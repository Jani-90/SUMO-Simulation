...
def read_existing_file(input_fileD, data_fileD, output_fileD):
    ...
    for x in range(len(counts)):
        ...
        for y in range(len(route)):
            if route['Direction Code'][y] == "S":
                routes.append(route['Route'][y])


        mask = counts['Depart Time'] == start_time
        count_s_value = counts.loc[mask, 'Count_S'].iloc[0]
        print(count_s_value)
        ...
        target_route_edges_list = [
            ...
            ["874420155", "821923311#0", "407171500#2", "407171500#3", "-821923309", "-229242998#3", "-229242998#2", "-229242998#1",
             "-229242998#0", "229242996#0", "229242996#1", "229242996#2", "229242996#3", "-1091754525#1", "-1091754525#0", "-1091754524",
             "874944056", "874944055#0", "874944055#1"],

            ["874420155", "821923311#0", "85469355#1", "821923308#0", "821923308#3", "874420151#0"]
        ]
        ...
        balance_veh = count_s_value - len(matching_cars) - len(matching_motorbike) - len(matching_bus) - len(matching_truck)
        print(balance_veh)
...
def apply_veh_class(input_file, data_file, output_file):
    ...
    for x in range(len(vclass)):
        if vclass['Dir'][x] == 'S':
            mask = (vclass['Time'] == vclass['Time'][x]) & (vclass['Dir'] == 'S')
            ...
            target_route_edges_list = [
                ...
                ["874420155", "821923311#0", "85469820#1"]
            ]
...
def main():
    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_11112024_Monday_4.rou.xml','data/forteenthAve-11112024-Monday.xlsx',"demand/all_petrol/vehicle_demand_fifteenthAve_11112024_Monday_5.rou.xml")
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_11112024_Monday_5.rou.xml", "data/forteenthAve-11112024-Monday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_11112024_Monday_6.rou.xml")

    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_12112024_Tuesday_4.rou.xml','data/forteenthAve-12112024-Tuesday.xlsx',"demand/all_petrol/vehicle_demand_fifteenthAve_12112024_Tuesday_5.rou.xml")
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_12112024_Tuesday_5.rou.xml", "data/forteenthAve-12112024-Tuesday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_12112024_Tuesday_6.rou.xml")

    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_13112024_Wednesday_4.rou.xml','data/forteenthAve-13112024-Wednesday.xlsx',"demand/all_petrol/vehicle_demand_fifteenthAve_13112024_Wednesday_5.rou.xml")
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_13112024_Wednesday_5.rou.xml", "data/forteenthAve-13112024-Wednesday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_13112024_Wednesday_6.rou.xml")

    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_14112024_Thursday_4.rou.xml','data/forteenthAve-14112024-Thursday.xlsx',"demand/all_petrol/vehicle_demand_fifteenthAve_14112024_Thursday_5.rou.xml")
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_14112024_Thursday_5.rou.xml", "data/forteenthAve-14112024-Thursday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_14112024_Thursday_6.rou.xml")

    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_08112024_Friday_4.rou.xml','data/forteenthAve-08112024-Friday.xlsx',"demand/all_petrol/vehicle_demand_fifteenthAve_08112024_Friday_5.rou.xml")
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_08112024_Friday_5.rou.xml", "data/forteenthAve-08112024-Friday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_08112024_Friday_6.rou.xml")

    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_09112024_Saturday_4.rou.xml','data/forteenthAve-09112024-Saturday.xlsx',"demand/all_petrol/vehicle_demand_fifteenthAve_09112024_Saturday_5.rou.xml")
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_09112024_Saturday_5.rou.xml", "data/forteenthAve-09112024-Saturday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_09112024_Saturday_6.rou.xml")

    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday_4.rou.xml','data/forteenthAve-10112024-Sunday.xlsx',"demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday_5.rou.xml")
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday_5.rou.xml", "data/forteenthAve-10112024-Sunday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday_6.rou.xml")
