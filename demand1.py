...
def read_existing_file(input_fileD, data_fileD):
    # === PARSE XML ===
    ...
    output_file = "demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday_1.rou.xml"
    ...
    for x in range(len(vclass)):
        if vclass['Dir'][x] == 'S':
            ...
            target_route_edges_list = [
                ...
                ["229243004", "1100993459#0", "85469355#1", "821923308#0", "821923308#3", "874420151#0"],
...
def main():
    #read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_11112024_Monday.rou.xml','data/sixteenthAve-11112024-Monday.xlsx')
    #apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_11112024_Monday_1.rou.xml", "data/sixteenthAve-11112024-Monday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_11112024_Monday_2.rou.xml")

    #read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_12112024_Tuesday.rou.xml','data/sixteenthAve-12112024-Tuesday.xlsx')
    #apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_12112024_Tuesday_1.rou.xml", "data/sixteenthAve-12112024-Tuesday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_12112024_Tuesday_2.rou.xml")

    #read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_13112024_Wednesday.rou.xml','data/sixteenthAve-13112024-Wednesday.xlsx')
    #apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_13112024_Wednesday_1.rou.xml", "data/sixteenthAve-13112024-Wednesday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_13112024_Wednesday_2.rou.xml")

    #read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_14112024_Thursday.rou.xml','data/sixteenthAve-14112024-Thursday.xlsx')
    #apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_14112024_Thursday_1.rou.xml", "data/sixteenthAve-14112024-Thursday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_14112024_Thursday_2.rou.xml")

    #read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_08112024_Friday.rou.xml','data/sixteenthAve-08112024-Friday.xlsx')
    #apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_08112024_Friday_1.rou.xml", "data/sixteenthAve-08112024-Friday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_08112024_Friday_2.rou.xml")

    #read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_09112024_Saturday.rou.xml','data/sixteenthAve-09112024-Saturday.xlsx')
    #apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_09112024_Saturday_1.rou.xml", "data/sixteenthAve-09112024-Saturday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_09112024_Saturday_2.rou.xml")

    read_existing_file('demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday.rou.xml','data/sixteenthAve-10112024-Sunday.xlsx')
    apply_veh_class("demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday_1.rou.xml", "data/sixteenthAve-10112024-Sunday.xlsx","demand/all_petrol/vehicle_demand_fifteenthAve_10112024_Sunday_2.rou.xml")
