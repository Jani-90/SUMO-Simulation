...
#==========================================================================================
#     Hourly CO2 Emission of Light-duty Vehicles for 24 hours based on the day of the week
#==========================================================================================
...
def plot_graph_vehicle_count(locationD):
  if locationD == "FIFTEENTH AVE":
    ...
    plt.figure() 
    plt.title('7 Days Hourly CO2 Emission of Light-duty Vehicles : Fifteenth Avenue Between Cameron Road and Devonport Road')
    ...
    time = ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00']
    plt.figure() 
    plt.title('7 Days Hourly CO2 Emission of Light-duty Vehicles : Newton Street Between Aerodrome Road and Tatua Way')
    ...
    time = ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00']
    plt.figure() 
    plt.title('7 Days Hourly CO2 Emission of Light-duty Vehicles : Turret Road Between Fifteenth Avenue and Harini Bridge')
