...
#==========================================================================================
#     Hourly Light-duty Vehicle Density for 24 hours based on the day of the week
...
def plot_graph_vehicle_count(locationD):
  if locationD == "FIFTEENTH AVE":
    x,y1 = generate_graph_data('FIFTEENTH AVE', '11112024')
    ...
    plt.figure() 
    plt.title('7 Days Hourly Light-duty Vehicle Density for 24 hours : Fifteenth Avenue Between Cameron Road and Devonport Road')
    ...
    time = ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00']
    plt.figure() 
    plt.title('7 Days Hourly Light-duty Vehicle Density for 24 hours : Newton Street Between Aerodrome Road and Tatua Way')

  elif locationD == "TURRET ROAD":
    x,y1 = generate_graph_data('TURRET ROAD', '21082023')
    x,y2 = generate_graph_data('TURRET ROAD', '22082023')
    x,y3 = generate_graph_data('TURRET ROAD', '23082023')
    x,y4 = generate_graph_data('TURRET ROAD', '24082023')
    x,y5 = generate_graph_data('TURRET ROAD', '18082023')
    x,y6 = generate_graph_data('TURRET ROAD', '19082023')
    x,y7 = generate_graph_data('TURRET ROAD', '20082023')
    time = ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00']
    plt.figure() 
    plt.title('7 Days Hourly Light-duty Vehicle Density for 24 hours : Turret Road Between Fifteenth Avenue and Harini Bridge')
  ...
  plt.plot(time, y1, color='#1F77B4', label='Monday', marker = 'o')
  plt.plot(time, y2, color='#FF7F0E', label='Tuesday', marker = 'o')
  plt.plot(time, y3, color='#2CA02C', label='Wednesday', marker = 'o')
  plt.plot(time, y4, color='#D62728', label='Thursday', marker = 'o')
  plt.plot(time, y5, color='#9467BD', label='Friday', marker = 'o')
  plt.plot(time, y6, color='#BCBD22', label='Saturday', marker = 'o')
  plt.plot(time, y7, color='#17BECF', label='Sunday', marker = 'o')
