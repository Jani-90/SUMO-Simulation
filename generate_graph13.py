...
# ==========================================================================================
#     Comparison of Hourly Total CO2 Emission of Vehicles after replacement of Trackless Tram
# ==========================================================================================
...
def generate_graph_data(locationD, dateD, contextD):
    ...
    mydoc = mycol.aggregate([
        {"$match": {
            ...
            "date": dateD,
            "context": contextD,
            "vType" : { "$in": ["Car", "Motor_Bike", "electricCar", "tracklessTram"] }
...
def plot_graph_vehicle_count(locationD):
    if locationD == "FIFTEENTH AVE":
        ...
        x, y2, t2 = generate_graph_data('FIFTEENTH AVE', '13112024', 'trackless_tram')
        time = ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00',
                '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00',
                '22:00', '23:00']
        plt.figure()
        plt.title(
            'Comparison of Hourly Total CO2 Emission of Vehicles after replacement of Trackless Trams : Fifteenth Avenue Between Cameron Road and Devonport Road')
        ...
        plt.figure()
        plt.title(
            'Comparison of Hourly Total CO2 Emission of Vehicles after replacement of Trackless Trams : Newton Street Between Aerodrome Road and Tatua Way')

    print(x)
    print(y1)
    print(y2)
    print(f"Real World Scenario : {t1}")
    print(f"Trackless Tram : {t2}")
    #print(y9)
    #   print(y3)
    #   print(y4)
    #   print(y5)
    ...
    plt.plot(time, y2, color='red', label='Trackless Tram', marker='o', linestyle='dashed')
